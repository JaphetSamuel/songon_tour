"""
Django settings for songon_tour project.
...
SECRET_KEY = 'django-insecure-07&c1-%j3i(ftpx)jno_&2p^yxftt$19%86@#fnzc=lrb3%oq^'
...
ROOT_URLCONF = 'songon_tour.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "songon_tour", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'songon_tour.wsgi.application'
